...
- Alternatively, you can use this emulator...
#+BEGIN_HTML
<iframe src="./js/jslinux/index.html" height=600px width=700px frameborder=0></iframe>
#+END_HTML
- Or...
#+BEGIN_HTML
...
- *NOTE TO SELF:* Embedded terminal could do with these:
- wget http://raw.githubusercontent.com/stsb11/9-CS-LinuxIntro-files/master/thefiles.zip
** Try It
:PROPERTIES:
:HTML_CONTAINER_CLASS: research
:END:
...
- *Platinum:* Make a new directory called 'LinuxChamp' inside the =a= directory, and move one of the joke files from the =a= directory into it. Screenshot the results of the =pwd= and =ls= command from the terminal as evidence you've completed the task.
